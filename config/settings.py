...
SECRET_KEY = "django-insecure-q5&is25t^lm^c4(lf*e-#p3$%g5=c6nuhh7f@-6d0yf4eco+dc"
...
CSRF_TRUSTED_ORIGINS = [
    'https://unsooty-flavoressly-marisha.ngrok-free.dev'
]
...
DATABASES = {
    'default': {
        ...
        'NAME': config('DB_NAME'),      
        'USER': config('DB_USER'),    # The User you created in Step 2
        'PASSWORD': config('DB_PASSWORD'),   # The password for that user
        'HOST': config('DB_HOST'),         # 'localhost' for local, IP for remote
